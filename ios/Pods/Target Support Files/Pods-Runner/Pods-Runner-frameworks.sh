...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/disk_space/disk_space.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/file_picker/file_picker.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/flutter_absolute_path/flutter_absolute_path.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/flutter_file_dialog/flutter_file_dialog.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/flutter_secure_storage/flutter_secure_storage.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/flutter_web_auth/flutter_web_auth.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/icloud_storage/icloud_storage.framework"
